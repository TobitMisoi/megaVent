                ...
                <>
                  <div className='row whyJoinInspire'>
                    <div className='inspire'>
                      <ul
                        className={cr ? 'inspire-content' : 'sponsor-content'}
                      >
                        <li>
                          <div
                            className={
                              cr ? 'whyJoin__content' : 'ourSponsors__content'
                            }
                          >
                            {cf ? <>{icon_1}</> : null}
                            <h3>{cf ? <>{heading3_1}</> : null}</h3>
                            <p>{cf ? <>{postHeading3_1Text}</> : null}</p>
                          </div>
                        </li>
                        <li>
                          <div
                          ...
                          >
                            ...
                            <p>{cf ? <>{postHeading3_2Text}</> : null}</p>
                          </div>
                        </li>
                        <li>
                          <div
                          ...
                          >
                            ...
                            <p>{cf ? <>{postHeading3_3Text}</> : null}</p>
                          </div>
                        </li>
                        {ck ? (
                          <>
                            <li>
                              <div
                                className={
                                  cr
                                    ? 'whyJoin__content'
                                    : 'ourSponsors__content'
                                }
                              >
                                {cf ? <>{icon_4}</> : null}
                                <h3>{cf ? <>{heading3_4}</> : null}</h3>
                                <p>{cf ? <>{postHeading3_4Text}</> : null}</p>
                              </div>
                            </li>
                          </>
                        ) : null}
